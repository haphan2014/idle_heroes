...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00274();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00263();
    ...
    final OnWindowAttachListener mWindowAttachListener = new C00241();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00252();

    class C00241 implements OnWindowAttachListener {
        C00241() {
        }
    ...
    class C00252 implements OnWindowFocusChangeListener {
        C00252() {
        }
    ...
    class C00263 extends BroadcastReceiver {
        C00263() {
        }
    ...
    class C00274 implements OnAudioFocusChangeListener {
        C00274() {
        }
