...
public class TransportMediator extends TransportController {
    ...
    class C00221 implements TransportMediatorCallback {
        C00221() {
        }
    ...
    class C00232 implements Callback {
        C00232() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C00221();
        this.mKeyEventCallback = new C00232();
