...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C00691();
        boolean isOpen;
    ...
    private void parallaxOtherViews(float slideOffset) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (v != this.mSlideableView) {
                ...
                v.offsetLeftAndRight(oldOffset - ((int) ((TextTrackStyle.DEFAULT_FONT_SCALE - slideOffset) * ((float) this.mParallaxBy))));
                if (dimViews) {
                    dimChildView(v, TextTrackStyle.DEFAULT_FONT_SCALE - this.mParallaxOffset, this.mCoveredFadeColor);
                }
            }
        }
    }
