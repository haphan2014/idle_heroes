...
public class TimeUtils {
    ...
    private static int formatDurationLocked(long duration, int fieldLen) {
        ...
        pos = printField(formatStr, minutes, AppLovinTargetingData.GENDER_MALE, pos, pos != start, zeropad ? 2 : 0);
        pos = printField(formatStr, seconds, 's', pos, pos != start, zeropad ? 2 : 0);
        int i = (!zeropad || pos == start) ? 0 : 3;
        pos = printField(formatStr, millis, AppLovinTargetingData.GENDER_MALE, pos, true, i);
        formatStr[pos] = 's';
        return pos + 1;
    }
