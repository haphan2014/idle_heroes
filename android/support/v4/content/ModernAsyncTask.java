...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00181();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00192();

    static class C00181 implements ThreadFactory {
    ...
    class C00192 extends WorkerRunnable<Params, Result> {
        C00192() {
            super();
        }
