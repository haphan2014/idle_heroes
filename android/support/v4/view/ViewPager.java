...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00471();
    ...
    private static final Interpolator sInterpolator = new C00482();
    ...
    private final Runnable mEndScrollRunnable = new C00493();
    ...
    static class C00471 implements Comparator<ItemInfo> {
        C00471() {
        }
    ...
    static class C00482 implements Interpolator {
        C00482() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00501());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C00501 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00501() {
            }
    ...
    private void calculatePageOffsets(ItemInfo curItem, int curIndex, ItemInfo oldCurInfo) {
        ...
        this.mLastOffset = curItem.position == N + -1 ? (curItem.offset + curItem.widthFactor) - TextTrackStyle.DEFAULT_FONT_SCALE : AutoScrollHelper.NO_MAX;
        int i = curIndex - 1;
        while (i >= 0) {
