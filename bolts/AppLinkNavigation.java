...
public class AppLinkNavigation {
    ...
    private Bundle buildAppLinkDataForNavigation(Context context) {
        ...
        data.putString(KEY_NAME_USER_AGENT, "Bolts Android 1.1.2");
    ...
    private void sendAppLinkNavigateEventBroadcast(Context context, Intent intent, NavigationResult type, JSONException e) {
        ...
        extraLoggingData.put(Response.SUCCESS_KEY, type.isSucceeded() ? AppEventsConstants.EVENT_PARAM_VALUE_YES : AppEventsConstants.EVENT_PARAM_VALUE_NO);
