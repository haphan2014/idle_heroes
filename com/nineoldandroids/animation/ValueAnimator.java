...
public class ValueAnimator extends Animator {
    ...
    private static final ThreadLocal<ArrayList<ValueAnimator>> sAnimations = new C16091();
    private static final Interpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sDelayedAnims = new C16113();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sEndingAnims = new C16124();
    private static final TypeEvaluator sFloatEvaluator = new FloatEvaluator();
    private static long sFrameDelay = DEFAULT_FRAME_DELAY;
    private static final TypeEvaluator sIntEvaluator = new IntEvaluator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sPendingAnimations = new C16102();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sReadyAnims = new C16135();
    ...
    static class C16091 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C16091() {
        }
    ...
    static class C16102 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C16102() {
        }
    ...
    static class C16113 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C16113() {
        }
    ...
    static class C16124 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C16124() {
        }
    ...
    static class C16135 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C16135() {
        }
    ...
    public void end() {
        ...
        if (this.mRepeatCount <= 0 || (this.mRepeatCount & 1) != 1) {
            animateValue(TextTrackStyle.DEFAULT_FONT_SCALE);
        } else {
            animateValue(0.0f);
        }
        endAnimation();
    ...
    boolean animationFrame(long currentTime) {
        ...
        switch (this.mPlayingState) {
            case 1:
            case 2:
                float fraction = this.mDuration > 0 ? ((float) (currentTime - this.mStartTime)) / ((float) this.mDuration) : TextTrackStyle.DEFAULT_FONT_SCALE;
                if (fraction >= TextTrackStyle.DEFAULT_FONT_SCALE) {
                    if (this.mCurrentIteration < this.mRepeatCount || this.mRepeatCount == -1) {
                        ...
                        fraction = Math.min(fraction, TextTrackStyle.DEFAULT_FONT_SCALE);
                    }
                }
                if (this.mPlayingBackwards) {
                    fraction = TextTrackStyle.DEFAULT_FONT_SCALE - fraction;
                }
