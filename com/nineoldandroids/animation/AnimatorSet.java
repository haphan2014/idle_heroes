...
public final class AnimatorSet extends Animator {
    ...
    public class Builder {
        ...
        public Builder after(long delay) {
            Animator anim = ValueAnimator.ofFloat(0.0f, TextTrackStyle.DEFAULT_FONT_SCALE);
    ...
    public void start() {
        ...
        if (this.mStartDelay <= 0) {
            ...
            this.mDelayAnim = ValueAnimator.ofFloat(0.0f, TextTrackStyle.DEFAULT_FONT_SCALE);
