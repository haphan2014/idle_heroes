...
class KeyframeSet {
    ...
    public static KeyframeSet ofInt(int... values) {
        ...
        if (numKeyframes == 1) {
            ...
            keyframes[1] = (IntKeyframe) Keyframe.ofInt(TextTrackStyle.DEFAULT_FONT_SCALE, values[0]);
        } else {
    ...
    public static KeyframeSet ofFloat(float... values) {
        ...
        if (numKeyframes == 1) {
            ...
            keyframes[1] = (FloatKeyframe) Keyframe.ofFloat(TextTrackStyle.DEFAULT_FONT_SCALE, values[0]);
        } else {
    ...
    public static KeyframeSet ofObject(Object... values) {
        ...
        if (numKeyframes == 1) {
            ...
            keyframes[1] = (ObjectKeyframe) Keyframe.ofObject(TextTrackStyle.DEFAULT_FONT_SCALE, values[0]);
        } else {
    ...
    public Object getValue(float fraction) {
        ...
        } else if (fraction >= TextTrackStyle.DEFAULT_FONT_SCALE) {
