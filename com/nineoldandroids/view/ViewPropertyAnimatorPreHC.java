...
class ViewPropertyAnimatorPreHC extends ViewPropertyAnimator {
    ...
    private static final int f743X = 128;
    private static final int f744Y = 256;
    private Runnable mAnimationStarter = new C16161();
    ...
    public ViewPropertyAnimator mo4318x(float value) {
    ...
    public ViewPropertyAnimator mo4320y(float value) {
    ...
    private void startAnimation() {
        ValueAnimator animator = ValueAnimator.ofFloat(TextTrackStyle.DEFAULT_FONT_SCALE);
