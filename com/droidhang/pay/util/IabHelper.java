...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        this.mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                if (!IabHelper.this.mDisposed) {
                    ...
                    String packageName = IabHelper.this.mPackageName;
                    try {
        ...
        List<ResolveInfo> riList = this.mContext.getPackageManager().queryIntentServices(serviceIntent, 0);
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, int requestCode, OnIabPurchaseFinishedListener listener, String extraData) {
        ...
        if (!itemType.equals(ITEM_TYPE_SUBS) || this.mSubscriptionsSupported) {
            ...
            try {
                ...
                Bundle buyIntentBundle = this.mService.getBuyIntent(3, this.mPackageName, sku, itemType, extraData);
    ...
    void consume(Purchase itemInfo) throws IabException {
        ...
        if (itemInfo.mItemType.equals(ITEM_TYPE_INAPP)) {
            try {
                ...
                int response = this.mService.consumePurchase(3, this.mPackageName, token);
                if (response == 0) {
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        ...
        logDebug("Package name: " + this.mPackageName);
        boolean verificationFailed = false;
        String continueToken = null;
        do {
            logDebug("Calling getPurchases with continuation token: " + continueToken);
            Bundle ownedItems = this.mService.getPurchases(3, this.mPackageName, itemType, continueToken);
    ...
    int querySkuDetails(String itemType, Inventory inv, List<String> moreSkus) throws RemoteException, JSONException {
        ...
        Bundle skuDetails = this.mService.getSkuDetails(3, this.mPackageName, itemType, querySkus);
