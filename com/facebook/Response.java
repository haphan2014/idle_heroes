...
public class Response {
    ...
    static List<Response> fromHttpConnection(HttpURLConnection connection, RequestBatch requests) {
        List<Response> createResponsesFromStream;
        ...
        if (requests instanceof CacheableRequestBatch) {
            ...
            if (!(cacheableRequestBatch.getForceRoundTrip() || cache == null || Utility.isNullOrEmpty(cacheKey))) {
                try {
                    ...
                    if (stream != null) {
                        createResponsesFromStream = createResponsesFromStream(stream, null, requests, true);
        ...
        try {
            ...
            createResponsesFromStream = createResponsesFromStream(stream, connection, requests, false);
