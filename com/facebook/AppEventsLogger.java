...
public class AppEventsLogger {
    ...
    static class C02223 implements Runnable {
        C02223() {
        }
    ...
    static class C02234 implements Runnable {
        C02234() {
        }
    ...
    static class PersistedAppSessionInfo {
        ...
        private static final Runnable appSessionInfoFlushRunnable = new C02271();
    ...
    static class SessionEventsState {
        ...
        public int populateRequest(Request request, boolean includeImplicitEvents, boolean limitEventUsage) {
            synchronized (this) {
        ...
        private void populateRequest(Request request, int numSkipped, JSONArray events, boolean limitEventUsage) {
            ...
            Utility.setAppEventAttributionParameters(publishParams, this.attributionIdentifiers, this.anonymousAppDeviceGUID, limitEventUsage);
            try {
        ...
        private byte[] getStringAsByteArray(String jsonString) {
            byte[] jsonUtf8 = null;
            try {
                jsonUtf8 = jsonString.getBytes(AsyncHttpResponseHandler.DEFAULT_CHARSET);
            } catch (Exception e) {
    ...
    private static void initializeTimersIfNeeded() {
        synchronized (staticLock) {
            ...
            backgroundExecutor.scheduleAtFixedRate(new C02223(), 0, 15, TimeUnit.SECONDS);
            backgroundExecutor.scheduleAtFixedRate(new C02234(), 0, 86400, TimeUnit.SECONDS);
        }
    }
