...
class AuthorizationClient implements Serializable {
    ...
    class C02302 implements StartActivityDelegate {
        C02302() {
        }
    ...
    boolean checkInternetPermission() {
        ...
        if (checkPermission("android.permission.INTERNET") != 0) {
            complete(Result.createErrorResult(this.pendingRequest, this.context.getString(C0271R.string.com_facebook_internet_permission_error_title), this.context.getString(C0271R.string.com_facebook_internet_permission_error_message)));
            return false;
        }
    ...
    StartActivityDelegate getStartActivityDelegate() {
        ...
        return this.pendingRequest != null ? new C02302() : null;
    }
    ...
    RequestBatch createReauthValidationBatch(Result pendingResult) {
