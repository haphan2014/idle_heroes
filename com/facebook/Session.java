...
public class Session implements Serializable {
    ...
    private static final Set<String> OTHER_PUBLISH_PERMISSIONS = new C02521();
    ...
    static class C02521 extends HashSet<String> {
        C02521() {
            add("ads_management");
            add("create_event");
            add("rsvp_event");
    ...
    class C02532 implements Callback {
        C02532() {
        }
    ...
    class C02543 implements OnCompletedListener {
        C02543() {
        }
    ...
    public static class AuthorizationRequest implements Serializable {
        ...
        class C02603 implements StartActivityDelegate {
            C02603() {
            }
        ...
        class C02614 implements StartActivityDelegate {
            C02614() {
            }
        ...
        private AuthorizationRequest(SessionLoginBehavior loginBehavior, int requestCode, List<String> permissions, String defaultAudience, boolean isLegacy, String applicationId, String validateSameFbidAsToken) {
            ...
            this.authId = UUID.randomUUID().toString();
            this.loggingExtras = new HashMap();
            this.startActivityDelegate = new C02603();
            this.loginBehavior = loginBehavior;
            this.requestCode = requestCode;
            this.permissions = permissions;
        ...
        AuthorizationRequest getAuthorizationClientRequest() {
            return new AuthorizationRequest(this.loginBehavior, this.requestCode, this.isLegacy, this.permissions, this.defaultAudience, this.applicationId, this.validateSameFbidAsToken, new C02614(), this.authId);
        }
    ...
    public final void refreshPermissions() {
        ...
        request.setCallback(new C02532());
        ...
        if (firstObject.getProperty("permission") != null) {
            for (GraphObject graphObject : data) {
                ...
                if (!permission.equals("installed")) {
                    String status = (String) graphObject.getProperty(Games.EXTRA_STATUS);
    ...
    void extendTokenCompleted(android.os.Bundle r6) {
        /*
        r5 = this;
        r2 = r5.lock;
        monitor-enter(r2);
        r0 = r5.state;	 Catch:{ all -> 0x0051 }
        r1 = com.facebook.Session.C02575.$SwitchMap$com$facebook$SessionState;	 Catch:{ all -> 0x0051 }
    ...
    L_0x001d:
        ...
        r2 = com.facebook.Session.C02575.$SwitchMap$com$facebook$SessionState;	 Catch:{ all -> 0x0034 }
        r4 = r7.state;	 Catch:{ all -> 0x0034 }
    ...
    private void tryLegacyAuth(AuthorizationRequest request) {
        ...
        this.authorizationClient.setOnCompletedListener(new C02543());
