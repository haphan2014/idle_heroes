...
public class LoginButton extends Button {
    ...
    private class LoginClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (openSession == null) {
                ...
                String message;
                String logout = LoginButton.this.getResources().getString(C0271R.string.com_facebook_loginview_log_out_action);
                String cancel = LoginButton.this.getResources().getString(C0271R.string.com_facebook_loginview_cancel_action);
                if (LoginButton.this.user == null || LoginButton.this.user.getName() == null) {
                    message = LoginButton.this.getResources().getString(C0271R.string.com_facebook_loginview_logged_in_using_facebook);
                } else {
                    message = String.format(LoginButton.this.getResources().getString(C0271R.string.com_facebook_loginview_logged_in_as), new Object[]{LoginButton.this.user.getName()});
                }
    ...
    public LoginButton(Context context, AttributeSet attrs) {
        ...
        if (attrs.getStyleAttribute() == 0) {
            setGravity(17);
            setTextColor(getResources().getColor(C0271R.color.com_facebook_loginview_text_color));
            setTextSize(0, getResources().getDimension(C0271R.dimen.com_facebook_loginview_text_size));
            setTypeface(Typeface.DEFAULT_BOLD);
            if (isInEditMode()) {
                setBackgroundColor(getResources().getColor(C0271R.color.com_facebook_blue));
                this.loginText = "Log in with Facebook";
            } else {
                setBackgroundResource(C0271R.drawable.com_facebook_button_blue);
                setCompoundDrawablesWithIntrinsicBounds(C0271R.drawable.com_facebook_inverse_icon, 0, 0, 0);
                setCompoundDrawablePadding(getResources().getDimensionPixelSize(C0271R.dimen.com_facebook_loginview_compound_drawable_padding));
                setPadding(getResources().getDimensionPixelSize(C0271R.dimen.com_facebook_loginview_padding_left), getResources().getDimensionPixelSize(C0271R.dimen.com_facebook_loginview_padding_top), getResources().getDimensionPixelSize(C0271R.dimen.com_facebook_loginview_padding_right), getResources().getDimensionPixelSize(C0271R.dimen.com_facebook_loginview_padding_bottom));
            }
        }
    ...
    private void checkNuxSettings() {
        if (this.nuxMode == ToolTipMode.DISPLAY_ALWAYS) {
            displayNux(getResources().getString(C0271R.string.com_facebook_tooltip_default));
            return;
        }
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, C0271R.styleable.com_facebook_login_view);
        this.confirmLogout = a.getBoolean(C0271R.styleable.com_facebook_login_view_confirm_logout, true);
        this.fetchUserInfo = a.getBoolean(C0271R.styleable.com_facebook_login_view_fetch_user_info, true);
        this.loginText = a.getString(C0271R.styleable.com_facebook_login_view_login_text);
        this.logoutText = a.getString(C0271R.styleable.com_facebook_login_view_logout_text);
        a.recycle();
    }
    ...
    private void setButtonText() {
        ...
        if (this.sessionTracker == null || this.sessionTracker.getOpenSession() == null) {
            if (this.loginText != null) {
                ...
                charSequence = getResources().getString(C0271R.string.com_facebook_loginview_log_in_button);
            }
        ...
        if (this.logoutText != null) {
            ...
            charSequence = getResources().getString(C0271R.string.com_facebook_loginview_log_out_button);
        }
        setText(charSequence);
    }
