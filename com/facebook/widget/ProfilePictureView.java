...
public class ProfilePictureView extends FrameLayout {
    ...
    class C03371 implements Callback {
        C03371() {
        }
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, C0271R.styleable.com_facebook_profile_picture_view);
        setPresetSize(a.getInt(C0271R.styleable.com_facebook_profile_picture_view_preset_size, -1));
        this.isCropped = a.getBoolean(C0271R.styleable.com_facebook_profile_picture_view_is_cropped, true);
        a.recycle();
    }
    ...
    private void setBlankProfilePicture() {
        if (this.customizedDefaultProfilePicture == null) {
            setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C0271R.drawable.com_facebook_profile_picture_blank_square : C0271R.drawable.com_facebook_profile_picture_blank_portrait));
            return;
        }
    ...
    private void sendImageRequest(boolean allowCachedResponse) {
        try {
            ImageRequest request = new Builder(getContext(), ImageRequest.getProfilePictureUrl(this.profileId, this.queryWidth, this.queryHeight)).setAllowCachedRedirects(allowCachedResponse).setCallerTag(this).setCallback(new C03371()).build();
    ...
    private int getPresetSizeInPixels(boolean forcePreset) {
        ...
        switch (this.presetSizeType) {
            case LARGE /*-4*/:
                dimensionId = C0271R.dimen.com_facebook_profilepictureview_preset_size_large;
                break;
            case NORMAL /*-3*/:
                dimensionId = C0271R.dimen.com_facebook_profilepictureview_preset_size_normal;
                break;
            case -2:
                dimensionId = C0271R.dimen.com_facebook_profilepictureview_preset_size_small;
                break;
            case -1:
                if (forcePreset) {
                    dimensionId = C0271R.dimen.com_facebook_profilepictureview_preset_size_normal;
