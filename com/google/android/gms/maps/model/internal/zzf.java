        ...
        private static class zza implements zzf {
            ...
            public LatLngBounds getBounds() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    LatLngBounds zzeO = obtain2.readInt() != 0 ? LatLngBounds.CREATOR.zzeO(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return zzeO;
                } catch (Throwable th) {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    if (data.readInt() != 0) {
                        zzeO = LatLngBounds.CREATOR.zzeO(data);
                    }
                    setPositionFromBounds(zzeO);
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                ...
                case 19:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    isVisible = zza(zzcM(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
                ...
                case Place.TYPE_CASINO /*21*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    zzu(com.google.android.gms.dynamic.zzd.zza.zzbg(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case Place.TYPE_CEMETERY /*22*/:
                    ...
                    zza(bitmapDescriptorParcelable);
                    reply.writeNoException();
                    return true;
                case 1598968902:
