...
public interface zzi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzi {
        ...
        private static class zza implements zzi {
            ...
            public boolean zzh(zzi com_google_android_gms_maps_model_internal_zzi) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 16:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    isDraggable = zzh(zzcP(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isDraggable) {
                        i = 1;
                    }
                ...
                case 18:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    zzv(com.google.android.gms.dynamic.zzd.zza.zzbg(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 19:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                ...
                case Place.TYPE_DENTIST /*28*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    if (data.readInt() != 0) {
                        bitmapDescriptorParcelable = BitmapDescriptorParcelable.CREATOR.zzfa(data);
                    }
    ...
    boolean zzh(zzi com_google_android_gms_maps_model_internal_zzi) throws RemoteException;
