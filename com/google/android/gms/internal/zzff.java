...
public interface zzff extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzff {
        ...
        private static class zza implements zzff {
            ...
            public void zza(zzfe com_google_android_gms_internal_zzfe) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseListener");
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzfe != null ? com_google_android_gms_internal_zzfe.asBinder() : null);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzfe.zza.zzL(data.readStrongBinder()));
    ...
    void zza(zzfe com_google_android_gms_internal_zzfe) throws RemoteException;
}
