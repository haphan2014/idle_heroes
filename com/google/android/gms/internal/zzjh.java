...
public interface zzjh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjh {
        ...
        private static class zza implements zzjh {
        ...
        public static zzjh zzan(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjh)) ? new zza(iBinder) : (zzjh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    zzi(data.readInt() != 0 ? (Status) Status.CREATOR.createFromParcel(data) : null);
