...
public class zzv implements zzb {
    ...
    static class zza {
        ...
        public static zza zzf(InputStream inputStream) throws IOException {
            ...
            com_google_android_gms_internal_zzv_zza.zzaC = zzv.zzd(inputStream);
    ...
    private void zzc(int i) {
        if (this.zzay + ((long) i) >= ((long) this.zzaA)) {
            ...
            while (it.hasNext()) {
                ...
                if (zzf(com_google_android_gms_internal_zzv_zza.zzaC).delete()) {
                    this.zzay -= com_google_android_gms_internal_zzv_zza.zzaB;
                } else {
                    zzs.zzb("Could not delete cache entry for key=%s, filename=%s", com_google_android_gms_internal_zzv_zza.zzaC, zze(com_google_android_gms_internal_zzv_zza.zzaC));
                }
                it.remove();
                i2 = i3 + 1;
    ...
    static String zzd(InputStream inputStream) throws IOException {
        return new String(zza(inputStream, (int) zzc(inputStream)), AsyncHttpResponseHandler.DEFAULT_CHARSET);
    }
        ...
        if (com_google_android_gms_internal_zzv_zza == null) {
            ...
            try {
                ...
                try {
                    ...
                    com_google_android_gms_internal_zzb_zza = com_google_android_gms_internal_zzv_zza.zzb(zza((InputStream) com_google_android_gms_internal_zzv_zzb, (int) (zzf.length() - ((long) com_google_android_gms_internal_zzv_zzb.zzaD))));
