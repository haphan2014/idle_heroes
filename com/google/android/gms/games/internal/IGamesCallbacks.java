        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case FitnessStatusCodes.INCONSISTENT_DATA_TYPE /*5002*/:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    zzf(data.readInt() != 0 ? DataHolder.CREATOR.zzS(data) : null);
                    reply.writeNoException();
                    return true;
                ...
                case FitnessStatusCodes.UNKNOWN_AUTH_ERROR /*5005*/:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    DataHolder zzS = data.readInt() != 0 ? DataHolder.CREATOR.zzS(data) : null;
                    if (data.readInt() != 0) {
                        dataHolder = DataHolder.CREATOR.zzS(data);
                    }
                    zza(zzS, dataHolder);
                ...
                case 12004:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    zza(data.readInt() != 0 ? DataHolder.CREATOR.zzS(data) : null, data.readInt() != 0 ? (Contents) Contents.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 12005:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                ...
                case 12017:
                    Contents contents;
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    DataHolder zzS2 = data.readInt() != 0 ? DataHolder.CREATOR.zzS(data) : null;
                    ...
                    zza(zzS2, readString, contents2, contents3, contents);
                    reply.writeNoException();
                    return true;
                case 13001:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
