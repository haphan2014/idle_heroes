...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class zza implements zzc {
            ...
            public IBinder zza(zzd com_google_android_gms_dynamic_zzd, zzef com_google_android_gms_internal_zzef, int i) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder zza = zza(com.google.android.gms.dynamic.zzd.zza.zzbg(data.readStrongBinder()), com.google.android.gms.internal.zzef.zza.zzE(data.readStrongBinder()), data.readInt());
    ...
    IBinder zza(zzd com_google_android_gms_dynamic_zzd, zzef com_google_android_gms_internal_zzef, int i) throws RemoteException;
}
