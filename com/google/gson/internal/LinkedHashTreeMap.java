...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C12481();
    ...
    static class C12481 implements Comparator<Comparable> {
        C12481() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C12491 extends LinkedTreeMapIterator<Entry<K, V>> {
            C12491() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C12501 extends LinkedTreeMapIterator<K> {
            C12501() {
                super();
            }
