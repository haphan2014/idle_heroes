...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C12511();
    ...
    static class C12511 implements Comparator<Comparable> {
        C12511() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C12521 extends LinkedTreeMapIterator<Entry<K, V>> {
            C12521() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C12531 extends LinkedTreeMapIterator<K> {
            C12531() {
                super();
            }
