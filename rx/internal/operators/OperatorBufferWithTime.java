...
public final class OperatorBufferWithTime<T> implements Operator<List<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C21001 implements Action0 {
            C21001() {
            }
        ...
        void scheduleExact() {
            this.inner.schedulePeriodically(new C21001(), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C21011 implements Action0 {
            C21011() {
            }
        ...
        void scheduleChunk() {
            this.inner.schedulePeriodically(new C21011(), OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.unit);
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super List<T>> child) {
        ...
        Subscriber parent2 = new InexactSubscriber(serialized, inner);
        parent2.add(inner);
        child.add(parent2);
