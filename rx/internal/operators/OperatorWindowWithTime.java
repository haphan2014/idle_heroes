...
public final class OperatorWindowWithTime<T> implements Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C22052 implements Action0 {
            C22052() {
            }
        ...
        void scheduleExact() {
            this.worker.schedulePeriodically(new C22052(), 0, OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C22061 implements Action0 {
            C22061() {
            }
        ...
        void scheduleChunk() {
            this.worker.schedulePeriodically(new C22061(), OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.unit);
        }
