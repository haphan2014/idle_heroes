...
public final class OnSubscribeRedo<T> implements OnSubscribe<T> {
    static final Func1<Observable<? extends Notification<?>>, Observable<?>> REDO_INFINITE = new C20751();
    ...
    static class C20751 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {

        class C20741 implements Func1<Notification<?>, Notification<?>> {
            C20741() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C20741());
        }
    }

    class C20793 implements Operator<Notification<?>, Notification<?>> {
        C20793() {
        }
    ...
    public static final class RedoFinite implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C20831 implements Func1<Notification<?>, Notification<?>> {
            int num;
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C20831()).dematerialize();
        }
    }
    ...
    public static final class RetryWithPredicate implements Func1<Observable<? extends Notification<?>>, Observable<? extends Notification<?>>> {
        ...
        class C20841 implements Func2<Notification<Integer>, Notification<?>, Notification<Integer>> {
            C20841() {
            }
        ...
        public Observable<? extends Notification<?>> call(Observable<? extends Notification<?>> ts) {
            return ts.scan(Notification.createOnNext(Integer.valueOf(0)), new C20841());
        }
    }
    ...
    public void call(Subscriber<? super T> child) {
        ...
        Action0 subscribeToSource = new Action0() {
            ...
            class C20761 extends Subscriber<T> {
                boolean done;
            ...
            public void call() {
                if (!subscriber.isUnsubscribed()) {
                    Subscriber<T> terminalDelegatingSubscriber = new C20761();
        ...
        final Observable<?> restarts = (Observable) this.controlHandlerFunction.call(terminals.lift(new C20793()));
