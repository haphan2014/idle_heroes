...
public final class OperatorMerge<T> implements Operator<T, Observable<? extends T>> {
    ...
    static final class MergeSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        protected void emitScalar(T r7, long r8) {
            ...
            r6 = this;
            r1 = 0;
            r3 = r6.child;	 Catch:{ Throwable -> 0x0036 }
        ...
        L_0x000f:
            r3 = r6.producer;	 Catch:{ all -> 0x0058 }
            r4 = 1;
            r3.produced(r4);	 Catch:{ all -> 0x0058 }
        L_0x0015:
            r3 = r6.scalarEmissionCount;	 Catch:{ all -> 0x0058 }
            r0 = r3 + 1;
            r3 = r6.scalarEmissionLimit;	 Catch:{ all -> 0x0058 }
            if (r0 != r3) goto L_0x0061;
        L_0x001d:
            r3 = 0;
            r6.scalarEmissionCount = r3;	 Catch:{ all -> 0x0058 }
            r4 = (long) r0;	 Catch:{ all -> 0x0058 }
            r6.requestMore(r4);	 Catch:{ all -> 0x0058 }
        L_0x0024:
            monitor-enter(r6);	 Catch:{ all -> 0x0058 }
            r1 = 1;
            r3 = r6.missed;	 Catch:{ all -> 0x0076 }
        ...
        L_0x0036:
            r2 = move-exception;
            r3 = r6.delayErrors;	 Catch:{ all -> 0x0058 }
            if (r3 != 0) goto L_0x0050;
        L_0x003b:
            rx.exceptions.Exceptions.throwIfFatal(r2);	 Catch:{ all -> 0x0058 }
            r1 = 1;
        ...
        L_0x004d:
            ...
            throw r3;
        L_0x0050:
            r3 = r6.getOrCreateErrorQueue();	 Catch:{ all -> 0x0058 }
