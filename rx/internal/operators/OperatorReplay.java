...
public final class OperatorReplay<T> extends ConnectableObservable<T> {
    static final Func0 DEFAULT_UNBOUNDED_FACTORY = new C21421();
    final Func0<? extends ReplayBuffer<T>> bufferFactory;
    final AtomicReference<ReplaySubscriber<T>> current;
    final Observable<? extends T> source;

    static class C21421 implements Func0 {
        C21421() {
        }
    ...
    static final class ReplaySubscriber<T> extends Subscriber<T> implements Subscription {
        ...
        class C21511 implements Action0 {
            C21511() {
            }
        ...
        void init() {
            add(Subscriptions.create(new C21511()));
        }
