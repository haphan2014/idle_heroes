...
public final class ProducerObserverArbiter<T> implements Producer, Observer<T> {
    static final Producer NULL_PRODUCER = new C22191();
    ...
    static class C22191 implements Producer {
        C22191() {
        }
    ...
    public void onNext(T r7) {
        ...
        r6 = this;
        monitor-enter(r6);
        r4 = r6.emitting;	 Catch:{ all -> 0x0040 }
        if (r4 == 0) goto L_0x0016;
    L_0x0005:
        r0 = r6.queue;	 Catch:{ all -> 0x0040 }
        if (r0 != 0) goto L_0x0011;
    L_0x0009:
        r0 = new java.util.ArrayList;	 Catch:{ all -> 0x0040 }
        r4 = 4;
        r0.<init>(r4);	 Catch:{ all -> 0x0040 }
        r6.queue = r0;	 Catch:{ all -> 0x0040 }
    L_0x0011:
    ...
    L_0x0016:
        r4 = 1;
        r6.emitting = r4;	 Catch:{ all -> 0x0040 }
        monitor-exit(r6);	 Catch:{ all -> 0x0040 }
        r1 = 0;
        r4 = r6.child;	 Catch:{ all -> 0x0043 }
        r4.onNext(r7);	 Catch:{ all -> 0x0043 }
        r2 = r6.requested;	 Catch:{ all -> 0x0043 }
    ...
    L_0x002b:
        r4 = 1;
        r4 = r2 - r4;
        r6.requested = r4;	 Catch:{ all -> 0x0043 }
    L_0x0031:
        r6.emitLoop();	 Catch:{ all -> 0x0043 }
        r1 = 1;
    ...
    L_0x0046:
        monitor-enter(r6);
        r5 = 0;
        r6.emitting = r5;	 Catch:{ all -> 0x004c }
    ...
    L_0x0013:
        monitor-enter(r11);
        r6 = r11.emitting;	 Catch:{ all -> 0x001f }
        if (r6 == 0) goto L_0x0022;
    L_0x0018:
        r6 = r11.missedRequested;	 Catch:{ all -> 0x001f }
        r6 = r6 + r12;
    ...
    L_0x0022:
        ...
        r1 = 0;
        r2 = r11.requested;	 Catch:{ all -> 0x004c }
        r4 = r2 + r12;
                ...
                for (T v : q) {
                    if (!c.isUnsubscribed()) {
                        ...
                        try {
                            ...
                            Exceptions.throwOrReport(ex, c, (Object) v);
                            return;
                        }
                    }
                    return;
