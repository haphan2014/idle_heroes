...
public final class ScalarSynchronousObservable<T> extends Observable<T> {
    ...
    public Observable<T> scalarScheduleOn(final Scheduler scheduler) {
        ...
        return Observable.create(new ScalarAsyncOnSubscribe(this.f3841t, onSchedule));
    }

    public <R> Observable<R> scalarFlatMap(final Func1<? super T, ? extends Observable<? extends R>> func) {
        return Observable.create(new OnSubscribe<R>() {
            public void call(Subscriber<? super R> child) {
                Observable<? extends R> o = (Observable) func.call(ScalarSynchronousObservable.this.f3841t);
                if (o instanceof ScalarSynchronousObservable) {
                    child.setProducer(ScalarSynchronousObservable.createProducer(child, ((ScalarSynchronousObservable) o).f3841t));
                } else {
