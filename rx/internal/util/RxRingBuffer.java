...
public class RxRingBuffer implements Subscription {
    ...
    public static final ObjectPool<Queue<Object>> SPMC_POOL = new C22372();
    public static final ObjectPool<Queue<Object>> SPSC_POOL = new C22361();
    private final ObjectPool<Queue<Object>> pool;
    private Queue<Object> queue;
    private final int size;
    public volatile Object terminalState;

    static class C22361 extends ObjectPool<Queue<Object>> {
        C22361() {
        }
    ...
    static class C22372 extends ObjectPool<Queue<Object>> {
        C22372() {
        }
