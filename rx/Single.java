...
public class Single<T> {
    ...
    protected Single(OnSubscribe<T> f) {
        ...
        this.onSubscribe = new rx.Observable.OnSubscribe<T>() {
    ...
    private Single(rx.Observable.OnSubscribe<T> f) {
        this.onSubscribe = RxJavaHooks.onCreate((rx.Observable.OnSubscribe) f);
    }
    ...
    public final <R> Single<R> lift(final Operator<? extends R, ? super T> lift) {
        return new Single(new rx.Observable.OnSubscribe<R>() {
        ...
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> t) {
                ...
                w.schedule(new Action0() {
                    ...
                    class C20111 extends SingleSubscriber<T> {
                        C20111() {
                        }
                    ...
                    public void call() {
                        SingleSubscriber single = new C20111();
                        t.add(single);
