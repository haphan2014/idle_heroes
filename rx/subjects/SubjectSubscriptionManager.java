...
final class SubjectSubscriptionManager<T> extends AtomicReference<State<T>> implements OnSubscribe<T> {
    ...
    protected static final class SubjectObserver<T> implements Observer<T> {
        ...
        void emitNext(java.lang.Object r2, rx.internal.operators.NotificationLite<T> r3) {
            /*
            r1 = this;
            r0 = r1.fastPath;
        ...
        /* JADX WARNING: inconsistent code. */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        void emitFirst(java.lang.Object r3, rx.internal.operators.NotificationLite<T> r4) {
            /*
            r2 = this;
            r0 = 0;
            monitor-enter(r2);
