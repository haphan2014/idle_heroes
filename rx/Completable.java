...
public class Completable {
    static final Completable COMPLETE = new Completable(new C19871(), false);
    static final Completable NEVER = new Completable(new C19942(), false);
    private final OnSubscribe onSubscribe;

    public interface OnSubscribe extends Action1<CompletableSubscriber> {
    }

    static class C19871 implements OnSubscribe {
        C19871() {
        }
    ...
    static class C19942 implements OnSubscribe {
        C19942() {
        }
                ...
                try {
                    ...
                    try {
                        ...
                        cs.unsafeSubscribe(new CompletableSubscriber() {
                            ...
                            class C19801 implements Action0 {
                                C19801() {
                                }
                            ...
                            public void onSubscribe(Subscription d) {
                                this.f3832d = d;
                                s.onSubscribe(Subscriptions.create(new C19801()));
                            }
                        });
                    } catch (Throwable ex2) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber s) {
                ...
                Completable.this.unsafeSubscribe(new CompletableSubscriber() {
                    ...
                    class C19821 implements Action0 {
                        C19821() {
                        }
                    ...
                    public void onCompleted() {
                        set.add(w.schedule(new C19821(), j, timeUnit));
                    }
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber s) {
                ...
                Completable.this.unsafeSubscribe(new CompletableSubscriber() {
                    ...
                    class C19881 implements Action0 {
                        C19881() {
                        }
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber s) {
                ...
                Completable.this.unsafeSubscribe(new CompletableSubscriber() {
                    ...
                    class C19921 implements CompletableSubscriber {
                        C19921() {
                        }
