...
public final class RxJavaHooks {
    ...
    static class C22831 implements Action1<Throwable> {
        C22831() {
        }
    ...
    static class C22842 implements Func2<Observable, Observable.OnSubscribe, Observable.OnSubscribe> {
        C22842() {
        }
    ...
    static class C22853 implements Func1<Subscription, Subscription> {
        C22853() {
        }
    ...
    static class C22864 implements Func2<Single, Observable.OnSubscribe, Observable.OnSubscribe> {
        C22864() {
        }
    ...
    static class C22875 implements Func1<Subscription, Subscription> {
        C22875() {
        }
    ...
    static class C22886 implements Func2<Completable, OnSubscribe, OnSubscribe> {
        C22886() {
        }
    ...
    static class C22897 implements Func1<Action0, Action0> {
        C22897() {
        }
    ...
    static class C22908 implements Func1<Throwable, Throwable> {
        C22908() {
        }
    ...
    static class C22919 implements Func1<Observable.Operator, Observable.Operator> {
        C22919() {
        }
    ...
    static void init() {
        onError = new C22831();
        onObservableStart = new C22842();
        onObservableReturn = new C22853();
        onSingleStart = new C22864();
        onSingleReturn = new C22875();
        onCompletableStart = new C22886();
        onScheduleAction = new C22897();
        onObservableSubscribeError = new C22908();
        onObservableLift = new C22919();
