...
public class RxJavaPlugins {
    static final RxJavaErrorHandler DEFAULT_ERROR_HANDLER = new C22921();
    ...
    static class C22921 extends RxJavaErrorHandler {
        C22921() {
        }
    }

    class C22932 extends RxJavaCompletableExecutionHook {
        C22932() {
        }
    }
    ...
    public RxJavaCompletableExecutionHook getCompletableExecutionHook() {
        if (this.completableExecutionHook.get() == null) {
            ...
            if (impl == null) {
                this.completableExecutionHook.compareAndSet(null, new C22932());
            } else {
